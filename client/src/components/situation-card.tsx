...
export default function SituationCard({ id, title, description, icon: Icon, delay = 0, className }: SituationCardProps) {
  return (
    <Link href={`/situations/${id}`}>
      <a className={cn("block h-full", className)}>
        <motion.div
          ...
          className="h-full"
        >
          <Card className="h-full p-5 overflow-hidden relative group hover:border-primary/50 transition-colors bg-white flex flex-col">
            ...
            <div className="relative z-10 flex flex-col flex-grow">
              ...
              <div className="flex items-center text-xs font-bold text-primary uppercase tracking-wider mt-auto pt-2">
